            ...
            <form onSubmit={handleSubscribe} className="space-y-4">
                <div className="flex flex-col gap-2">
                    <input
                        ...
                        className="px-4 py-2 text-sm bg-slate-50/90 border border-slate-100 text-black rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent flex-1 placeholder-slate-500"
