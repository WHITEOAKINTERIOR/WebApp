            ...
            <div className="container mx-auto px-4 py-16 md:py-12 relative z-20">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
                    ...
                    <div className="lg:col-span-2 space-y-6 justify-center">
                        <div className="text-2xl text-center md:text-5xl font-bold tracking-tight text-white [text-shadow:1px_1px_6px_rgba(0,0,0,0.8)] leading-relaxed md:leading-normal">
